...
public class Evenement {
  ...
  String CONTACT_E ; 
    ...
    public Evenement(int ID_EVENEMENT, int ID_UTILISATEUR, String TITRE_E, String DESCRIPTION_E, String AFFICHE_E, Date DATEDEBUT_E, Date DATEFIN_E, String LIEU_E, String DUREE_E, float FRAIS_E, String ORGANISATEUR_E, String CONTACT_E) {
    ...
    public void setDUREE_E(String DUREE_E) {
        this.DUREE_E = DUREE_E;
    }
